...
# http://en.wikipedia.org/wiki/List_of_tz_zones_by_nameeurope
...
SECRET_KEY = '7guh3^%gd1yd+w)89%z_siva=p7r#p!(yy&9*m#+bd))51-v_('
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/xala/workarea/django-tutorial/mysite/templates',
